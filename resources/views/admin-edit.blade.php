                        ...
                        <table class="table">
                            <tr>
                                <td>
                                    ...
                                    <div class="form-check form-switch mb-3">
                                        <input class="form-check-input" type="checkbox" name="form20" value="1" role="switch" id="flexSwitchCheckCheckedDisabled" <?php if ($user->form20 == 1) echo "checked";?> >
                                        <label class="form-check-label" for="flexSwitchCheckChecked">Growth Assessment</label>
                                    </div>
                                    <div class="form-check form-switch mb-3">
                                        <input class="form-check-input" type="checkbox" name="form21" value="1" role="switch" id="flexSwitchCheckCheckedDisabled" <?php if ($user->form21 == 1) echo "checked";?> >
                                ...
                                <td>
                                    ...
                                    <div class="form-check form-switch mb-3">
                                        <input class="form-check-input" type="checkbox" name="form19" value="1" role="switch" id="flexSwitchCheckCheckedDisabled" <?php if ($user->form19 == 1) echo "checked";?> >
                                        <label class="form-check-label" for="flexSwitchCheckChecked">Growth Quenstionnaire</label>
                                    </div>
                                    <div class="form-check form-switch mb-3">
                                        <input class="form-check-input" type="checkbox" name="form22" value="1" role="switch" id="flexSwitchCheckCheckedDisabled" <?php if ($user->form22 == 1) echo "checked";?> >
