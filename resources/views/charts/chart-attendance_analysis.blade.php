                                        ...
                                        <div class="">
                                            <ul>
                                                @foreach ($query['question1'] as $question1)
                                                    <li>{{ $question1->commrep_question1 }} - {{ $question1->y }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="">
                                            <ul>
                                                @foreach ($query['question2'] as $question2)
                                                    <li>{{ $question2->commrep_question2 }} - {{ $question2->y }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                        <div class="col-12">
        ...
        window.onload = function(){
            ...
            $(function(){
                Highcharts.chart('question1', {
                    ...
                    tooltip: {
                        pointFormat: '{point.commrep_question1}: <b>{point.percentage:.1f}%</b>'
                    },
                    accessibility: {
                        point: {
                            valueSuffix:'%'
                    ...
                    plotOptions: {
                        pie: {
                            ...
                            dataLabels: {
                                enabled: true,
                                format: '<b>{point.commrep_question1}</b>: {point.percentage:.1f}%',
                                style: {
                                    fontSize: '17px'
                                }
                            },
            ...
            $(function(){
                Highcharts.chart('question2', {
                    ...
                    tooltip: {
                        pointFormat: '{point.commrep_question2}: <b>{point.percentage:.1f}%</b>'
                    },
                    accessibility: {
                        point: {
                            valueSuffix:'%'
                    ...
                    plotOptions: {
                        pie: {
                            ...
                            dataLabels: {
                                enabled: true,
                                format: '<b>{point.commrep_question2}</b>: {point.percentage:.1f}%',
                                style: {
                                    fontSize: '17px'
                                }
                            },
