                                ...
                                <ol>
                                    <li>
                                        ...
                                        <div class="">
                                            <ul>
                                                @foreach ($query['question1'] as $question1)
                                                    <li>{{ $question1->llm_question1 }} - {{ $question1->y }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="mb">
                                            ...
                                            <ul>
                                                @foreach ($query['llm_comment1'] as $llm_comment1)
                                                    <li>{{ $llm_comment1->llm_comment1 }} - {{ $llm_comment1->count }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="">
                                            <ul>
                                                @foreach ($query['question2'] as $question2)
                                                    <li>{{ $question2->llm_question2 }} - {{ $question2->y }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="mb">
                                            <label for="" class="form-label">Comments</label>
                                            <ul>
                                                @foreach ($query['llm_comment2'] as $llm_comment2)
                                                    <li>{{ $llm_comment2->llm_comment2 }} - {{ $llm_comment2->count }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="">
                                            <ul>
                                                @foreach ($query['question3'] as $question3)
                                                    <li>{{ $question3->llm_question3 }} - {{ $question3->y }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="mb">
                                            <label for="" class="form-label">Comments</label>
                                            <ul>
                                                @foreach ($query['llm_comment3'] as $llm_comment3)
                                                    <li>{{ $llm_comment3->llm_comment3 }} - {{ $llm_comment3->count }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="">
                                            <ul>
                                                @foreach ($query['question4'] as $question4)
                                                    <li>{{ $question4->llm_question4 }} - {{ $question4->y }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="mb">
                                            <label for="" class="form-label">Comments</label>
                                            <ul>
                                                @foreach ($query['llm_comment4'] as $llm_comment4)
                                                    <li>{{ $llm_comment4->llm_comment4 }} - {{ $llm_comment4->count }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="">
                                            <ul>
                                                @foreach ($query['question5'] as $question5)
                                                    <li>{{ $question5->llm_question5 }} - {{ $question5->y }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="mb">
                                            <label for="" class="form-label">Comments</label>
                                            <ul>
                                                @foreach ($query['llm_comment5'] as $llm_comment5)
                                                    <li>{{ $llm_comment5->llm_comment5 }} - {{ $llm_comment5->count }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="">
                                            <ul>
                                                @foreach ($query['question6'] as $question6)
                                                    <li>{{ $question6->llm_question6 }} - {{ $question6->y }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="mb">
                                            <label for="" class="form-label">Comments</label>
                                            <ul>
                                                @foreach ($query['llm_comment6'] as $llm_comment6)
                                                    <li>{{ $llm_comment6->llm_comment6 }} - {{ $llm_comment6->count }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="">
                                            <ul>
                                                @foreach ($query['question7'] as $question7)
                                                    <li>{{ $question7->llm_question7 }} - {{ $question7->y }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="mb">
                                            <label for="" class="form-label">Comments</label>
                                            <ul>
                                                @foreach ($query['llm_comment7'] as $llm_comment7)
                                                    <li>{{ $llm_comment7->llm_comment7 }} - {{ $llm_comment7->count }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="">
                                            <ul>
                                                @foreach ($query['question8'] as $question8)
                                                    <li>{{ $question8->llm_question8 }} - {{ $question8->y }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="mb">
                                            <label for="" class="form-label">Comments</label>
                                            <ul>
                                                @foreach ($query['llm_comment8'] as $llm_comment8)
                                                    <li>{{ $llm_comment8->llm_comment8 }} - {{ $llm_comment8->count }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="">
                                            <ul>
                                                @foreach ($query['question9'] as $question9)
                                                    <li>{{ $question9->llm_question9 }} - {{ $question9->y }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="mb">
                                            <label for="" class="form-label">Comments</label>
                                            <ul>
                                                @foreach ($query['llm_comment9'] as $llm_comment9)
                                                    <li>{{ $llm_comment9->llm_comment9 }} - {{ $llm_comment9->count }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="">
                                            <ul>
                                                @foreach ($query['question10'] as $question10)
                                                    <li>{{ $question10->llm_question10 }} - {{ $question10->y }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="mb">
                                            <label for="" class="form-label">Comments</label>
                                            <ul>
                                                @foreach ($query['llm_comment10'] as $llm_comment10)
                                                    <li>{{ $llm_comment10->llm_comment10 }} - {{ $llm_comment10->count }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="">
                                            <ul>
                                                @foreach ($query['question11'] as $question11)
                                                    <li>{{ $question11->llm_question11 }} - {{ $question11->y }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="mb">
                                            <label for="" class="form-label">Comments</label>
                                            <ul>
                                                @foreach ($query['llm_comment11'] as $llm_comment11)
                                                    <li>{{ $llm_comment11->llm_comment11 }} - {{ $llm_comment11->count }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="">
                                            <ul>
                                                @foreach ($query['question12'] as $question12)
                                                    <li>{{ $question12->llm_question12 }} - {{ $question12->y }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="mb">
                                            <label for="" class="form-label">Comments</label>
                                            <ul>
                                                @foreach ($query['llm_comment12'] as $llm_comment12)
                                                    <li>{{ $llm_comment12->llm_comment12 }} - {{ $llm_comment12->count }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="">
                                            <ul>
                                                @foreach ($query['question13'] as $question13)
                                                    <li>{{ $question13->llm_question13 }} - {{ $question13->y }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="mb">
                                            <label for="" class="form-label">Comments</label>
                                            <ul>
                                                @foreach ($query['llm_comment13'] as $llm_comment13)
                                                    <li>{{ $llm_comment13->llm_comment13 }} - {{ $llm_comment13->count }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="">
                                            <ul>
                                                @foreach ($query['question14'] as $question14)
                                                    <li>{{ $question14->llm_question14 }} - {{ $question14->y }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="mb">
                                            <label for="" class="form-label">Comments</label>
                                            <ul>
                                                @foreach ($query['llm_comment14'] as $llm_comment14)
                                                    <li>{{ $llm_comment14->llm_comment14 }} - {{ $llm_comment14->count }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="">
                                            <ul>
                                                @foreach ($query['question15'] as $question15)
                                                    <li>{{ $question15->llm_question15 }} - {{ $question15->y }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="mb">
                                            <label for="" class="form-label">Comments</label>
                                            <ul>
                                                @foreach ($query['llm_comment15'] as $llm_comment15)
                                                    <li>{{ $llm_comment15->llm_comment15 }} - {{ $llm_comment15->count }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="">
                                            <ul>
                                                @foreach ($query['question16'] as $question16)
                                                    <li>{{ $question16->llm_question16 }} - {{ $question16->y }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="mb">
                                            <label for="" class="form-label">Comments</label>
                                            <ul>
                                                @foreach ($query['llm_comment16'] as $llm_comment16)
                                                    <li>{{ $llm_comment16->llm_comment16 }} - {{ $llm_comment16->count }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="">
                                            <ul>
                                                @foreach ($query['question17'] as $question17)
                                                    <li>{{ $question17->llm_question17 }} - {{ $question17->y }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="mb">
                                            <label for="" class="form-label">Comments</label>
                                            <ul>
                                                @foreach ($query['llm_comment17'] as $llm_comment17)
                                                    <li>{{ $llm_comment17->llm_comment17 }} - {{ $llm_comment17->count }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="">
                                            <ul>
                                                @foreach ($query['question18'] as $question18)
                                                    <li>{{ $question18->llm_question18 }} - {{ $question18->y }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="mb">
                                            <label for="" class="form-label">Comments</label>
                                            <ul>
                                                @foreach ($query['llm_comment18'] as $llm_comment18)
                                                    <li>{{ $llm_comment18->llm_comment18 }} - {{ $llm_comment18->count }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="">
                                            <ul>
                                                @foreach ($query['question19'] as $question19)
                                                    <li>{{ $question19->llm_question19 }} - {{ $question19->y }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="mb">
                                            <label for="" class="form-label">Comments</label>
                                            <ul>
                                                @foreach ($query['llm_comment19'] as $llm_comment19)
                                                    <li>{{ $llm_comment19->llm_comment19 }} - {{ $llm_comment19->count }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="">
                                            <ul>
                                                @foreach ($query['question20'] as $question20)
                                                    <li>{{ $question20->llm_question20 }} - {{ $question20->y }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="mb">
                                            <label for="" class="form-label">Comments</label>
                                            <ul>
                                                @foreach ($query['llm_comment20'] as $llm_comment20)
                                                    <li>{{ $llm_comment20->llm_comment20 }} - {{ $llm_comment20->count }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </li>
                                        ...
                                        <div class="">
                                            <ul>
                                                @foreach ($query['question21'] as $question21)
                                                    <li>{{ $question21->llm_question21 }} - {{ $question21->y }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                        <div class="col-12">
                                    ...
                                    <li>
                                        ...
                                        <div class="">
                                            <ul>
                                                @foreach ($query['question22'] as $question22)
                                                    <li>{{ $question22->llm_question22 }} - {{ $question22->y }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                        <div class="col-12">
                                            <div class="card graph mb-3 ml-4 col-12">
                                                <div class="card-body text-primary" id="question22" style="height: 400px; margin: 0 auto">
        ...
        window.onload = function(){
            ...
            $(function(){
                Highcharts.chart('question1', {
                    ...
                    tooltip: {
                        pointFormat: '{point.llm_question1}: <b>{point.percentage:.1f}%</b>'
                    },
                    accessibility: {
                        point: {
                            valueSuffix:'%'
                    ...
                    plotOptions: {
                        pie: {
                            ...
                            dataLabels: {
                                enabled: true,
                                format: '<b>{point.llm_question1}</b>: {point.percentage:.1f}%',
                                style: {
                                    fontSize: '17px'
                                }
                            },
             ...
             $(function(){
                Highcharts.chart('question2', {
                    ...
                    tooltip: {
                        pointFormat: '{point.llm_question2}: <b>{point.percentage:.1f}%</b>'
                    },
                    accessibility: {
                        point: {
                            valueSuffix:'%'
                    ...
                    plotOptions: {
                        pie: {
                            ...
                            dataLabels: {
                                enabled: true,
                                format: '<b>{point.llm_question2}</b>: {point.percentage:.1f}%',
                                style: {
                                    fontSize: '17px'
                                }
                            },
             ...
             $(function(){
                Highcharts.chart('question3', {
                    ...
                    tooltip: {
                        pointFormat: '{point.llm_question3}: <b>{point.percentage:.1f}%</b>'
                    },
                    accessibility: {
                        point: {
                            valueSuffix:'%'
                    ...
                    plotOptions: {
                        pie: {
                            ...
                            dataLabels: {
                                enabled: true,
                                format: '<b>{point.llm_question3}</b>: {point.percentage:.1f}%',
                                style: {
                                    fontSize: '17px'
                                }
                            },
             ...
             $(function(){
                Highcharts.chart('question4', {
                    ...
                    tooltip: {
                        pointFormat: '{point.llm_question4}: <b>{point.percentage:.1f}%</b>'
                    },
                    accessibility: {
                        point: {
                            valueSuffix:'%'
                    ...
                    plotOptions: {
                        pie: {
                            ...
                            dataLabels: {
                                enabled: true,
                                format: '<b>{point.llm_question4}</b>: {point.percentage:.1f}%',
                                style: {
                                    fontSize: '17px'
                                }
                            },
             ...
             $(function(){
                Highcharts.chart('question5', {
                    ...
                    tooltip: {
                        pointFormat: '{point.llm_question5}: <b>{point.percentage:.1f}%</b>'
                    },
                    accessibility: {
                        point: {
                            valueSuffix:'%'
                    ...
                    plotOptions: {
                        pie: {
                            ...
                            dataLabels: {
                                enabled: true,
                                format: '<b>{point.llm_question5}</b>: {point.percentage:.1f}%',
                                style: {
                                    fontSize: '17px'
                                }
                            },
             ...
             $(function(){
                Highcharts.chart('question6', {
                    ...
                    tooltip: {
                        pointFormat: '{point.llm_question6}: <b>{point.percentage:.1f}%</b>'
                    },
                    accessibility: {
                        point: {
                            valueSuffix:'%'
                    ...
                    plotOptions: {
                        pie: {
                            ...
                            dataLabels: {
                                enabled: true,
                                format: '<b>{point.llm_question6}</b>: {point.percentage:.1f}%',
                                style: {
                                    fontSize: '17px'
                                }
                            },
             ...
             $(function(){
                Highcharts.chart('question7', {
                    ...
                    tooltip: {
                        pointFormat: '{point.llm_question7}: <b>{point.percentage:.1f}%</b>'
                    },
                    accessibility: {
                        point: {
                            valueSuffix:'%'
                    ...
                    plotOptions: {
                        pie: {
                            ...
                            dataLabels: {
                                enabled: true,
                                format: '<b>{point.llm_question7}</b>: {point.percentage:.1f}%',
                                style: {
                                    fontSize: '17px'
                                }
                            },
             ...
             $(function(){
                Highcharts.chart('question8', {
                    ...
                    tooltip: {
                        pointFormat: '{point.llm_question8}: <b>{point.percentage:.1f}%</b>'
                    },
                    accessibility: {
                        point: {
                            valueSuffix:'%'
                    ...
                    plotOptions: {
                        pie: {
                            ...
                            dataLabels: {
                                enabled: true,
                                format: '<b>{point.llm_question8}</b>: {point.percentage:.1f}%',
                                style: {
                                    fontSize: '17px'
                                }
                            },
             ...
             $(function(){
                Highcharts.chart('question9', {
                    ...
                    tooltip: {
                        pointFormat: '{point.llm_question9}: <b>{point.percentage:.1f}%</b>'
                    },
                    accessibility: {
                        point: {
                            valueSuffix:'%'
                    ...
                    plotOptions: {
                        pie: {
                            ...
                            dataLabels: {
                                enabled: true,
                                format: '<b>{point.llm_question9}</b>: {point.percentage:.1f}%',
                                style: {
                                    fontSize: '17px'
                                }
                            },
             ...
             $(function(){
                Highcharts.chart('question10', {
                    ...
                    tooltip: {
                        pointFormat: '{point.llm_question10}: <b>{point.percentage:.1f}%</b>'
                    },
                    accessibility: {
                        point: {
                            valueSuffix:'%'
                    ...
                    plotOptions: {
                        pie: {
                            ...
                            dataLabels: {
                                enabled: true,
                                format: '<b>{point.llm_question10}</b>: {point.percentage:.1f}%',
                                style: {
                                    fontSize: '17px'
                                }
                            },
             ...
             $(function(){
                Highcharts.chart('question11', {
                    ...
                    tooltip: {
                        pointFormat: '{point.llm_question11}: <b>{point.percentage:.1f}%</b>'
                    },
                    accessibility: {
                        point: {
                            valueSuffix:'%'
                    ...
                    plotOptions: {
                        pie: {
                            ...
                            dataLabels: {
                                enabled: true,
                                format: '<b>{point.llm_question11}</b>: {point.percentage:.1f}%',
                                style: {
                                    fontSize: '17px'
                                }
                            },
             ...
             $(function(){
                Highcharts.chart('question12', {
                    ...
                    tooltip: {
                        pointFormat: '{point.llm_question12}: <b>{point.percentage:.1f}%</b>'
                    },
                    accessibility: {
                        point: {
                            valueSuffix:'%'
                    ...
                    plotOptions: {
                        pie: {
                            ...
                            dataLabels: {
                                enabled: true,
                                format: '<b>{point.llm_question12}</b>: {point.percentage:.1f}%',
                                style: {
                                    fontSize: '17px'
                                }
                            },
             ...
             $(function(){
                Highcharts.chart('question13', {
                    ...
                    tooltip: {
                        pointFormat: '{point.llm_question13}: <b>{point.percentage:.1f}%</b>'
                    },
                    accessibility: {
                        point: {
                            valueSuffix:'%'
                    ...
                    plotOptions: {
                        pie: {
                            ...
                            dataLabels: {
                                enabled: true,
                                format: '<b>{point.llm_question13}</b>: {point.percentage:.1f}%',
                                style: {
                                    fontSize: '17px'
                                }
                            },
             ...
             $(function(){
                Highcharts.chart('question14', {
                    ...
                    tooltip: {
                        pointFormat: '{point.llm_question14}: <b>{point.percentage:.1f}%</b>'
                    },
                    accessibility: {
                        point: {
                            valueSuffix:'%'
                    ...
                    plotOptions: {
                        pie: {
                            ...
                            dataLabels: {
                                enabled: true,
                                format: '<b>{point.llm_question14}</b>: {point.percentage:.1f}%',
                                style: {
                                    fontSize: '17px'
                                }
                            },
             ...
             $(function(){
                Highcharts.chart('question15', {
                    ...
                    tooltip: {
                        pointFormat: '{point.llm_question15}: <b>{point.percentage:.1f}%</b>'
                    },
                    accessibility: {
                        point: {
                            valueSuffix:'%'
                    ...
                    plotOptions: {
                        pie: {
                            ...
                            dataLabels: {
                                enabled: true,
                                format: '<b>{point.llm_question15}</b>: {point.percentage:.1f}%',
                                style: {
                                    fontSize: '17px'
                                }
                            },
             ...
             $(function(){
                Highcharts.chart('question16', {
                    ...
                    tooltip: {
                        pointFormat: '{point.llm_question16}: <b>{point.percentage:.1f}%</b>'
                    },
                    accessibility: {
                        point: {
                            valueSuffix:'%'
                    ...
                    plotOptions: {
                        pie: {
                            ...
                            dataLabels: {
                                enabled: true,
                                format: '<b>{point.llm_question16}</b>: {point.percentage:.1f}%',
                                style: {
                                    fontSize: '17px'
                                }
                            },
             ...
             $(function(){
                Highcharts.chart('question17', {
                    ...
                    tooltip: {
                        pointFormat: '{point.llm_question17}: <b>{point.percentage:.1f}%</b>'
                    },
                    accessibility: {
                        point: {
                            valueSuffix:'%'
                    ...
                    plotOptions: {
                        pie: {
                            ...
                            dataLabels: {
                                enabled: true,
                                format: '<b>{point.llm_question17}</b>: {point.percentage:.1f}%',
                                style: {
                                    fontSize: '17px'
                                }
                            },
             ...
             $(function(){
                Highcharts.chart('question18', {
                    ...
                    tooltip: {
                        pointFormat: '{point.llm_question18}: <b>{point.percentage:.1f}%</b>'
                    },
                    accessibility: {
                        point: {
                            valueSuffix:'%'
                    ...
                    plotOptions: {
                        pie: {
                            ...
                            dataLabels: {
                                enabled: true,
                                format: '<b>{point.llm_question18}</b>: {point.percentage:.1f}%',
                                style: {
                                    fontSize: '17px'
                                }
                            },
             ...
             $(function(){
                Highcharts.chart('question19', {
                    ...
                    tooltip: {
                        pointFormat: '{point.llm_question19}: <b>{point.percentage:.1f}%</b>'
                    },
                    accessibility: {
                        point: {
                            valueSuffix:'%'
                    ...
                    plotOptions: {
                        pie: {
                            ...
                            dataLabels: {
                                enabled: true,
                                format: '<b>{point.llm_question19}</b>: {point.percentage:.1f}%',
                                style: {
                                    fontSize: '17px'
                                }
                            },
             ...
             $(function(){
                Highcharts.chart('question20', {
                    ...
                    tooltip: {
                        pointFormat: '{point.llm_question20}: <b>{point.percentage:.1f}%</b>'
                    },
                    accessibility: {
                        point: {
                            valueSuffix:'%'
                    ...
                    plotOptions: {
                        pie: {
                            ...
                            dataLabels: {
                                enabled: true,
                                format: '<b>{point.llm_question20}</b>: {point.percentage:.1f}%',
                                style: {
                                    fontSize: '17px'
                                }
                            },
             ...
             $(function(){
                Highcharts.chart('question21', {
                    ...
                    tooltip: {
                        pointFormat: '{point.llm_question21}: <b>{point.percentage:.1f}%</b>'
                    },
                    accessibility: {
                        point: {
                            valueSuffix:'%'
                    ...
                    plotOptions: {
                        pie: {
                            ...
                            dataLabels: {
                                enabled: true,
                                format: '<b>{point.llm_question21}</b>: {point.percentage:.1f}%',
                                style: {
                                    fontSize: '17px'
                                }
                            },
             ...
             $(function(){
                Highcharts.chart('question22', {
                    ...
                    tooltip: {
                        pointFormat: '{point.llm_question22}: <b>{point.percentage:.1f}%</b>'
                    },
                    accessibility: {
                        point: {
                            valueSuffix:'%'
                    ...
                    plotOptions: {
                        pie: {
                            ...
                            dataLabels: {
                                enabled: true,
                                format: '<b>{point.llm_question22}</b>: {point.percentage:.1f}%',
                                style: {
                                    fontSize: '17px'
                                }
                            },
