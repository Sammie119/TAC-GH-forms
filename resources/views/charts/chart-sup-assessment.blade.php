                            ...
                            <form action="{{ route('supassesstment') }}" id="sup_assonitor" method="POST">
                                ...
                                <ol>
                                    <li>
                                        ...
                                        <div class="mb">
                                            <ul>
                                                @foreach ($query['sup_ass_comment1'] as $sup_ass_comment1)
                                                    <li>{{ $sup_ass_comment1->sup_ass_comment1 }} - {{ $sup_ass_comment1->count }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="mb">
                                            <ul>
                                                @foreach ($query['sup_ass_comment2'] as $sup_ass_comment2)
                                                    <li>{{ $sup_ass_comment2->sup_ass_comment2 }} - {{ $sup_ass_comment2->count }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="mb">
                                            <ul>
                                                @foreach ($query['sup_ass_comment3'] as $sup_ass_comment3)
                                                    <li>{{ $sup_ass_comment3->sup_ass_comment3 }} - {{ $sup_ass_comment3->count }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="mb">
                                            <ul>
                                                @foreach ($query['sup_ass_comment4'] as $sup_ass_comment4)
                                                    <li>{{ $sup_ass_comment4->sup_ass_comment4 }} - {{ $sup_ass_comment4->count }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="mb">
                                            <ul>
                                                @foreach ($query['sup_ass_comment5'] as $sup_ass_comment5)
                                                    <li>{{ $sup_ass_comment5->sup_ass_comment5 }} - {{ $sup_ass_comment5->count }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="mb">
                                            <ul>
                                                @foreach ($query['sup_ass_comment6'] as $sup_ass_comment6)
                                                    <li>{{ $sup_ass_comment6->sup_ass_comment6 }} - {{ $sup_ass_comment6->count }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <div class="mb">
                                            <ul>
                                                @foreach ($query['sup_ass_comment7'] as $sup_ass_comment7)
                                                    <li>{{ $sup_ass_comment7->sup_ass_comment7 }} - {{ $sup_ass_comment7->count }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="mb">
                                            <ul>
                                                @foreach ($query['sup_ass_comment8'] as $sup_ass_comment8)
                                                    <li>{{ $sup_ass_comment8->sup_ass_comment8 }} - {{ $sup_ass_comment8->count }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="mb">
                                            <ul>
                                                @foreach ($query['sup_ass_comment9'] as $sup_ass_comment9)
                                                    <li>{{ $sup_ass_comment9->sup_ass_comment9 }} - {{ $sup_ass_comment9->count }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="mb">
                                            <ul>
                                                @foreach ($query['sup_ass_comment10'] as $sup_ass_comment10)
                                                    <li>{{ $sup_ass_comment10->sup_ass_comment10 }} - {{ $sup_ass_comment10->count }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="mb">
                                            <ul>
                                                @foreach ($query['sup_ass_comment11'] as $sup_ass_comment11)
                                                    <li>{{ $sup_ass_comment11->sup_ass_comment11 }} - {{ $sup_ass_comment11->count }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="mb">
                                            <ul>
                                                @foreach ($query['sup_ass_comment12'] as $sup_ass_comment12)
                                                    <li>{{ $sup_ass_comment12->sup_ass_comment12 }} - {{ $sup_ass_comment12->count }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="mb">
                                            <ul>
                                                @foreach ($query['sup_ass_comment13'] as $sup_ass_comment13)
                                                    <li>{{ $sup_ass_comment13->sup_ass_comment13 }} - {{ $sup_ass_comment13->count }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </li>
