                                ...
                                <form action="{{ route('area-head') }}" method="POST" id="areaheadonitor">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 mb-4"> 
                                            <input name="areahead_district" value="{{ $data->areahead_district }}" required type="text" id="date-picker-example" class="form-control datepicker" style="font-family:Arial, FontAwesome"> 
                                            <small class="d-flex justify-content-center">Name of District</small>
                                        </div>
                                        <div class="col-sm-6"> 
                                            <input name="areahead_area" value="{{ $data->areahead_area }}" required type="text" id="date-picker-example" class="form-control datepicker" style="font-family:Arial, FontAwesome"> 
                                            <small class="d-flex justify-content-center">Name of Area</small>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6 mb-4"> 
                                            <input name="areahead_local" value="{{ $data->areahead_local }}" required type="text" id="date-picker-example" class="form-control datepicker" style="font-family:Arial, FontAwesome"> 
