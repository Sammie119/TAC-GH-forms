                                ...
                                <form action="{{ route('district-past-report') }}" id="distpastonitor" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 mb-4"> 
                                            <input name="distpast_district" value="{{ $data->distpast_district }}" required type="text" id="date-picker-example" class="form-control datepicker" style="font-family:Arial, FontAwesome"> 
                                            <small class="d-flex justify-content-center">Name of District</small>
                                        </div>
                                        <div class="col-sm-6"> 
                                            <input name="distpast_area" value="{{ $data->distpast_area }}" required type="text" id="date-picker-example" class="form-control datepicker" style="font-family:Arial, FontAwesome"> 
                                            <small class="d-flex justify-content-center">Name of Area</small>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6 mb-4"> 
                                            <input name="distpast_local" value="{{ $data->distpast_local }}" required type="text" id="date-picker-example" class="form-control datepicker" style="font-family:Arial, FontAwesome"> 
