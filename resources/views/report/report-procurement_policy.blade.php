                ...
                <tbody>
                    @foreach ($data as $key => $data)
                        <tr>
                            ...
                            @if (Auth()->user()->user_role != 0)
                                <td>
                                    <a href="#/{{ $data->procurement_id }}" class="btn btn-success btn-sm" style="text-decoration: none" title="Delete">Edit</a>
                                    @if (Auth()->user()->user_role == 1)
                                        <a href="#/{{ $data->procurement_id }}" class="btn btn-danger btn-sm" style="text-decoration: none" title="Delete">Delete</a> 
                                    @endif
                                </td>
                            @endif
                        </tr>
