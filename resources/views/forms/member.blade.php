    ...
    <div class="card text-dark bg-light mb-3 col-8">
        ...
        <div class="card-body">
            <form action="{{ route('member-report') }}" id="memberonitor" method="POST">
                @csrf
                <div class="row">
                    <div class="col-sm-6"> <input name="member_district" required placeholder="Name of District" type="text" id="date-picker-example" class="form-control datepicker mb-4" style="font-family:Arial, FontAwesome"> </div>
                    <div class="col-sm-6"> <input name="member_area" required placeholder="Area" type="text" id="date-picker-example" class="form-control datepicker" style="font-family:Arial, FontAwesome"> </div>
                </div>
                <div class="row">
                    <div class="col-sm-6"> <input name="member_local" required placeholder="Local Assembly" type="text" id="date-picker-example" class="form-control datepicker mb-4" style="font-family:Arial, FontAwesome"> </div>
