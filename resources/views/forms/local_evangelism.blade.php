    ...
    <div class="card text-dark bg-light mb-3 col-8">
        ...
        <div class="card-body">
            <form action="{{ route('local-evangelism') }}" id="evangeonitor" method="POST">
                ...
                <div class="row">
                    <div class="col-sm-6"> 
                        <input name="evange_district" placeholder="Name of District" list="districtOptions" required type="text" id="date-picker-example" class="form-control datepicker mb-4" style="font-family:Arial, FontAwesome"> 
                    </div>
                    <div class="col-sm-6">
                        <input name="evange_area" placeholder="Name of Area" list="areaOptions" required type="text" id="date-picker-example" class="form-control datepicker mb-4" style="font-family:Arial, FontAwesome">   
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6"> 
                        <input name="evange_local" placeholder="Name of Local Assembly" list="localOptions" required type="text" id="date-picker-example" class="form-control datepicker mb-4" style="font-family:Arial, FontAwesome"> 
                    </div>
