    ...
    <div class="card text-dark bg-light mb-3 col-8">
        ...
        <div class="card-body">
            <form action="{{ route('record-books-district') }}" id="rec_distonitor" method="POST">
                @csrf
                <div class="row">
                    <div class="col-sm-6"> <input name="rec_dist_area" required placeholder="Area" type="text" id="date-picker-example" class="form-control datepicker mb-4" style="font-family:Arial, FontAwesome"> </div>
                ...
                <div class="row">
                    <div class="col-sm-6"> <input name="rec_dist_district" required placeholder="District" type="text" id="date-picker-example" class="form-control datepicker mb-4" style="font-family:Arial, FontAwesome"> </div>
                    <div class="col-sm-6"> <input name="rec_dist_prepared_by" required placeholder="Prepared By" type="text" id="date-picker-example" class="form-control datepicker mb-4" style="font-family:Arial, FontAwesome"> </div>
                </div>
                <div class="row">
