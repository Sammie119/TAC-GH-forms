        ...
        <div class="card text-dark bg-light mb-3 col-6" style="margin-top: 100px;">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('registration') }}" method="POST">
                    @csrf
                    <div class="row mb-4">
                        <div class="col-sm-12"> <input name="name" required placeholder="Enter Name" type="text" id="date-picker-example" class="form-control datepicker" style="font-family:Arial, FontAwesome"> </div>
                        @if ($errors->has('name'))
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-12"> <input name="email" required placeholder="Enter Email" type="email" id="date-picker-example" class="form-control datepicker" style="font-family:Arial, FontAwesome"> </div>
                        @if ($errors->has('email'))
