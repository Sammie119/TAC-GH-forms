    ...
    */
    public function collection()
    {
        ...
        elseif($this->destination == 'Area'){
            return VWLocalEvangelism::where('area', $this->destination_name)->get();
        }
        elseif($this->destination == 'District'){
            return VWLocalEvangelism::where('district', $this->destination_name)->get();
        }
        elseif($this->destination == 'Local'){
            return VWLocalEvangelism::where('local', $this->destination_name)->get();
        }
